...
main:
    ...
    # Inicializar el mayor número como el primer número ingresado
    li $v0, 4
    la $a0, prompt_num
    syscall
    ...
    li $v0, 5
    syscall
    move $t2, $v0  # Guardar primer número en $t2 (mayor actual)
...
loop:
    ...
    ble $t1, $t2, continuar  # Si no es mayor, continuar
    move $t2, $t1  # Actualizar el mayor número
